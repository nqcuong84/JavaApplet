...
public class applet_b6 extends JApplet {
int intNgay;
int intThang;
int intNam;
	/**
...
public void init() {
	try {
	 intNgay=Integer.parseInt(JOptionPane.showInputDialog("Nhập ngày dương lịch", null));
	 intThang  =Integer.parseInt(JOptionPane.showInputDialog("Nhập tháng dương lịch", null));
	 intNam =Integer.parseInt(JOptionPane.showInputDialog("Nhập năm dương lịch", null));
	
}
	catch(NumberFormatException e) {
		JOptionPane.showMessageDialog(null,"Ngày/Tháng/Năm không hợp lệ, vui lòng nhập lại");
		init();
	}
}
public void paint (Graphics g) {
	String s="Ngày dương lịch: "+String.valueOf(intNgay)+"/"+ String.valueOf(intThang)+"/"+String.valueOf(intNam);
	g.drawString(s, 30, 30);
	g.drawString(convertSolar2Lunar(intNgay,intThang,intNam), 30, 50);
}
...
String convertSolar2Lunar(int intNgay, int intThang, int intNam)
{
    ...
    return "Ngày âm:"+String.valueOf(Ngay)+"/"+ String.valueOf(Thang)+"/"+String.valueOf(Nam);
}
}
